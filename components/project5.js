...
export default function Project5() {
    ...
    return (
        ...
        <div className="md:w-[85vw] md:h-[35rem] w-[21rem] h-[65rem] p-4 rounded-2xl bg-slate-800 shadow-slate-700 flex flex-col ease-linear duration-300 md:flex-row-reverse">
