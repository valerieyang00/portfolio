  ...
  return (
    ...
    <div className={styles.container}>
      ...
      <div className="flex flex-wrap justify-center gap-2">
        <button className="scale-100 hover:scale-125 ease-in duration-100 bg-gray-700 p-2 font-semibold text-white inline-flex items-center space-x-2 rounded">
        ...
        <button className="scale-100 hover:scale-125 ease-in duration-100 bg-gray-700 p-2 font-semibold text-white inline-flex items-center space-x-2 rounded">resume
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
  ...
  <div className="container m-auto px-6 text-gray-600 md:px-12 xl:px-6">
      <div className="space-y-6 md:space-y-0 md:flex md:gap-6 lg:items-center lg:gap-12">
        <div className="md:5/12 lg:w-5/12">
          <img src="/head.png" alt="image" loading="lazy" width="" height=""/>
        </div>
